    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="<?= site_url('Stock/out'); ?>" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <form action="<?= site_url('Stock/process2'); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detail" placeholder="rusak/kadaluarsa/etc*" required>
                </div>
                <div class="form-group">
                    <label for="qty">qty<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="qty" placeholder="jumlah*" required autofocus>
                </div>
                <button type="submit" name="add_process_out" class="btn btn-primary float-right ml-3"><i class="fas fa-save"></i> simpan</button>
