<section class="content pl-3 pt-3 pb-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?= site_url('User/edit_process'); ?>" method="POST">
                <?php foreach ($member as $u) : ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="<?= $u->name; ?>" placeholder="nama*" required>
                        <?= form_error('name', '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="phone">nomor hp<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="phone" value="<?= $u->phone; ?>" placeholder="nomor hp*" required>
                        <?= form_error('phone', '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="address">alamat<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="address" placeholder="alamat*" value="<?= $u->address; ?>" required>
