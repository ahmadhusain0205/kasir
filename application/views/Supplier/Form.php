    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="<?= site_url('Supplier'); ?>" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <?= form_open_multipart('Supplier/process'); ?>
            <div class="form-group">
                <label for="name">nama<span class="text-danger">*</span></label>
                <input type="hidden" class="form-control" name="supplier_id" value="<?= $row->supplier_id; ?>">
                <input type="text" class="form-control" name="name" value="<?= $row->name; ?>" placeholder="name*" required autofocus>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="description" value="<?= $row->description; ?>" placeholder="deskripsi">
